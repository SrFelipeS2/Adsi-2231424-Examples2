...
<body id="colores">
    <div class="row">
        <div class="col-md-4 offset-md-4">
            <h3 id="color" class="text-center mt-5">Alta de Alumnos</h3>
            <form action="procesarDatos/InsertarAlumno.php" method="POST">
                ...
                <div class="mb-3">
                    <label for="Sueldo" class="form-label"> Email</label>
                    <input type="email" class="form-control" id="Sueldo" name="mail" >
                    
                </div>
                <div class="mb-3">
                    <label  class="form-label"> Seleccione el Curso</label>
                    <select name="codigocurso" class="d-inline-block ">
