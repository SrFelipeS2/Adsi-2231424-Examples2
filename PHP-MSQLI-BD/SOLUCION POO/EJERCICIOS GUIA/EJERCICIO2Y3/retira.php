...
<body>
<form action="procesar/procesar_retira.php" method="POST">
<header class="row">
        ...
        <div class="rounded border border-5  border-dark shadow-lg mx-auto mb-3 mt-3 col-8">
            ...
            <div class="border border-5  border-dark mx-auto mb-3 mt-3 color1 ">
                ...
                <div class="container mb-3">
                    <h4>
                        ...
                        Para usted retirar solo debe diligenciar el siguiente formulario, cuando lo llene y presione el boton de retirar se le generara una clave para que pueda ir a un cajero automatico a retirar su dienero, recuerde que solo dispone de 30 minutos para retirar su dinero, finalizado los 30 minutos la clave no funcionara y debera generar una nueva.
                        <br>
                        <br>
                        <i class="fa-solid fa-circle-check"></i>
                        recuerde que en nuestras oficinas tambien puede hacer cualquier tipo de transaccion, ya sea un retiro de dinero o una consignacion, el horario de atencion es de 24 horas y de lunes a sabado.
                    </h4>
                </div>
            </div>
            <div class="border border-5 container border-dark mx-auto mb-3 mt-3 color1 ">
                <fieldset class="border border-2 border-dark p-4 my-3">
                    <legend>Retiro con Codigo</legend>
                    <?php
                        if ($error) :
                        ?>
                    ...
                    <div class="input-group mb-3">
                        <span class="input-group-text">Monto a Retirar</span>
                ...
                <button  type="submit" class=" border border-4 border-dark btn d-block mx-auto BG-2 text-center mb-3" >
                    <i class="fa fa-paper-plane" aria-hidden="true"></i> RETIRAR
                </button>
            </div>
        </div>
    </section>
