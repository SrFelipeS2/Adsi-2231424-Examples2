...
<body>
    <form action="./procesar/procesar_envia.php" method="POST">
    <header class="row">
            ...
            <div class="border border-5 container border-dark mx-auto mb-3 mt-3 color1 ">
                <fieldset class="border border-2 border-dark p-4 my-3">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="text" class="form-control" name="usuario1" placeholder="Usuario de BIAV" aria-label="Username" aria-describedby="basic-addon1">
                    </div>
                    
                    <div class="input-group mb-3">
                        <span class="input-group-text">Numero de la Cuenta</span>
                        <input type="number" class="form-control"  name="cuenta1" aria-label="Amount (to the nearest dollar)">
                    </div>
                    <div class="input-group mb-3">
                ...
                <fieldset class="border border-2 border-dark p-4 my-3">
                    ...
                    <div class="input-group mb-3">
                        <span class="input-group-text" id="basic-addon1">Nombre de Usuario</span>
                        <input type="text" class="form-control"  name="usuario2"   placeholder="Usuario de BIAV" aria-label="Username" aria-describedby="basic-addon1">
                    </div>

                    <div class="input-group mb-3">
                        <span class="input-group-text">Numero de la Cuenta</span>
                        <input type="number" class="form-control" name="cuenta2" aria-label="Amount (to the nearest dollar)">
                    </div>

                </fieldset>
                <button type="submit" class=" mx-auto border border-4 border-dark btn d-block BG-2 text-center mb-3" href="envia.php">
