...
<style>
    ...
    body section div div.border6 {
        border: dotted 5px #0BE3CC;
    }

    body section div div a.btnc-6 {
        background-color: #0BE3CC;
    }
        ...
        <div class="rounded border border-5  border-dark shadow-lg mx-auto mb-3 mt-3 col-8">
            ...
            <div class=" border border-5  border-dark container color1 mb-3 mt-3 ">
                ...
                <div class="row col-12 mb-3 mt-3  border5 p-4">
                    ...
                    <div class="col-6">
                        <a class=" bordr border-5 border-dark btn btn mx-4 btnc-5 text-center" href="usuarios.php" role="button">
                            <i class="fa fa-paper-plane" aria-hidden="true"></i> INFORMACION USUARIOS
                        </a>
                    </div>
                </div>
                <div class="row col-12 mb-3 mt-3  border6 p-4">
                    <div class="col-5">
                        <h3 class="d-inline">
                            Cerrar Sesion
                            <i class="fa-solid fa-circle-arrow-right"></i>
                    ...
                    <div class="col-6">
                        <a class=" bordr border-5 border-dark btn btn mx-4 btnc-6 text-center" href="index.php?cerrarSesion=1" role="button">
