...
class Paciente extends BaseModel
{
    ...
    /* public function borrar(){
     ...
     $sql = $this -> dbConnection -> prepare("DELETE from paciente WHERE documento = :id");
     $sql ->bindParam(":id", $this -> documento);
     $sql -> execute();
   ...
   /*  public function selection($id){
    ...
    /* public function editar(){
        $sql = $this -> dbConnection -> prepare("UPDATE paciente set nombre = ?, direccion = ?, telefono = ?, fecha_nacimiento = ?, estado = ?, genero = ?, eps = ?, email = ? WHERE documento = ?");
